/* Probe 3D: six custom mons survive CB2_InitBattle, then battle flags become normal trainer. */
final class BrockNormalEndBattleProbePreset {
    private static final long VIRTUAL_BASE = 0x08010000L;
    private static final int VAR_MARKER = 0x8005;
    private static final int SPECIAL_PLAY_SPECIAL_MAP_MUSIC = 153;

    private BrockNormalEndBattleProbePreset() {}
    ...
    static TriggerBuildResult build(RomProfile rom, ObjectEventTarget target) {
        ...
        NativeHelper helper = BrockNormalEndBattleNative.buildAt(rom, stagingAddress);
        NativeHelperInstaller.Plan plan = NativeHelperInstaller.prepare(
                b, VIRTUAL_BASE, helper, copierAddress,
                "brock_normal_end_battle_helper", NativeHelperInstaller.Mode.AUTO);
