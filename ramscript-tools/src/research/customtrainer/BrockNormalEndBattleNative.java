...
*/
final class BrockNormalEndBattleNative {
    ...
    private BrockNormalEndBattleNative() {}
    ...
    static NativeHelper buildAt(RomProfile rom, long stagingAddress) {
        ...
        t.literal("endTrainerBattle", endTrainerBattleThumb(rom));
