...
final class BrockCompletionFlagProbePreset {
    ...
    private BrockCompletionFlagProbePreset() {}
    ...
    static TriggerBuildResult build(RomProfile rom, ObjectEventTarget target) {
        ...
        NativeHelper helper = BrockCompletionFlagProbeNative.buildAt(rom, stagingAddress);
