...
*/
final class BrockDialogueFlowProbeNative {
    ...
    private BrockDialogueFlowProbeNative() {}
    ...
    static NativeHelper buildAt(RomProfile rom, long stagingAddress) {
        ...
        t.label("defeat_text");
        byte[] defeatText = Gen3TextCodec.encodeString("You have become much stronger!");
        t.raw(defeatText);
        if ((t.pos() & 1) != 0)
            t.raw(new byte[] {0});
