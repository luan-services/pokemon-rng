/*
   Build 47b: complete two-boundary evolution-scene probe.
...
*/
final class TradeEvolutionSceneProbe47bPreset {
    ...
    private static final int PROBE_BEFORE_PARTY = 0x47B1;
    private static final int PROBE_BEFORE_EVO = 0x47B2;
    private static final int PROBE_AFTER_EVO = 0x47B3;
    private static final int PROBE_NO_EVOLUTION = 0x47B0;
    private static final int PROBE_CANCELLED = 0x47BC;

    private TradeEvolutionSceneProbe47bPreset() {}
    ...
    static byte[] buildPayload(RomProfile rom) {
        if (rom != RomProfile.FIRE_RED_EN_10)
            throw new IllegalArgumentException("Build 47b evolution-scene probe currently supports fr10 only");
        ...
        NativeHelperInstaller.Plan evoInstall = NativeHelperInstaller.prepare(
                b, VIRTUAL_BASE, evoHelper, evoCopierAddress, "trade_evo_47b",
